				...
				<tr>
					<td>
						<div class="input-group mb-1">
							수정 아이디 : &nbsp;<input name="update_id"
								value="${memoboard.update_id}" />※ 수정 아이디는 최대 15자까지 입력 가능합니다.
						</div>
					</td>
				</tr>
				<tr>
					<td>
						<div class="input-group mb-1">
							제&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;목 : &nbsp;
							<input style="width: 530px;" name="title"
								value="${memoboard.title}" />
						</div>
					</td>
				</tr>
				<tr>
					<td>
						<div class="input-group mb-1">
							공 지 여 부 : &nbsp;<input type="radio" name="notice_yn" id="Y"
								value="Y"
								<c:if test="${memoboard.notice_yn eq 'Y'}">checked</c:if> />공지
							등록&nbsp; <input type="radio" name="notice_yn" id="N" value="N"
								<c:if test="${memoboard.notice_yn eq 'N'}">checked</c:if> />공지
							해제
						</div>
					</td>
				</tr>
					...
					<td>
						...
						<div>
							<button class="btn btn-success" type="button"
								onclick="updateProc()">작성</button>
							<button class="btn btn-dark" type="button"
								onclick="goback(${memoboard.no})">뒤로가기</button>
